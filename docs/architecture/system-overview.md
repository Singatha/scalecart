...
idempotent inventory reservation. Successful orders enter `pending_payment`. Phase 6 completes and
hardens the Order Service boundary; payment authorization follows in Phase 7.
